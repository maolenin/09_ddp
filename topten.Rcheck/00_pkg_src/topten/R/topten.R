...
#'
#' This function develops a prediction algorithm based on the top yen features
...
#' @details
#' This functions runs a univariate regression of y on each predictor in x and
#' calculates a p-value indicating the significance of the association. The
#' final set of predictors is tales from the 10 smallest p-values
#' @seealso \code{lm}
#' @export
...
#' Predictions with top ten features
#'
#' This function takes a set of coefficients produced by th \code{topten}
